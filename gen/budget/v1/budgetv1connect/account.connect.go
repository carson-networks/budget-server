...
const (
	...
	AccountServiceName = "budget.v1.AccountService"
)
...
const (
	...
	// ListAccounts RPC.
	AccountServiceListAccountsProcedure = "/budget.v1.AccountService/ListAccounts"
	// AccountServiceCreateAccountProcedure is the fully-qualified name of the AccountService's
	// CreateAccount RPC.
	AccountServiceCreateAccountProcedure = "/budget.v1.AccountService/CreateAccount"
	// AccountServiceSyncAccountsProcedure is the fully-qualified name of the AccountService's
	// SyncAccounts RPC.
	AccountServiceSyncAccountsProcedure = "/budget.v1.AccountService/SyncAccounts"
)

// AccountServiceClient is a client for the budget.v1.AccountService service.
type AccountServiceClient interface {
	...
	SyncAccounts(context.Context, *connect.Request[v1.SyncAccountsRequest]) (*connect.Response[v1.SyncAccountsResponse], error)
}

// NewAccountServiceClient constructs a client for the budget.v1.AccountService service. By default,
...
func NewAccountServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AccountServiceClient {
	...
	accountServiceMethods := v1.File_budget_v1_account_proto.Services().ByName("AccountService").Methods()
	return &accountServiceClient{
		...
		syncAccounts: connect.NewClient[v1.SyncAccountsRequest, v1.SyncAccountsResponse](
			httpClient,
...
type accountServiceClient struct {
	...
	syncAccounts  *connect.Client[v1.SyncAccountsRequest, v1.SyncAccountsResponse]
}

// ListAccounts calls budget.v1.AccountService.ListAccounts.
...
// CreateAccount calls budget.v1.AccountService.CreateAccount.
...
// SyncAccounts calls budget.v1.AccountService.SyncAccounts.
func (c *accountServiceClient) SyncAccounts(ctx context.Context, req *connect.Request[v1.SyncAccountsRequest]) (*connect.Response[v1.SyncAccountsResponse], error) {
	return c.syncAccounts.CallUnary(ctx, req)
}

// AccountServiceHandler is an implementation of the budget.v1.AccountService service.
...
func NewAccountServiceHandler(svc AccountServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/budget.v1.AccountService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAccountServiceHandler) ListAccounts(context.Context, *connect.Request[v1.ListAccountsRequest]) (*connect.Response[v1.ListAccountsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("budget.v1.AccountService.ListAccounts is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) CreateAccount(context.Context, *connect.Request[v1.CreateAccountRequest]) (*connect.Response[v1.CreateAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("budget.v1.AccountService.CreateAccount is not implemented"))
}

func (UnimplementedAccountServiceHandler) SyncAccounts(context.Context, *connect.Request[v1.SyncAccountsRequest]) (*connect.Response[v1.SyncAccountsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("budget.v1.AccountService.SyncAccounts is not implemented"))
}
