...
const (
	...
	TransactionServiceName = "budget.v1.TransactionService"
)
...
const (
	...
	TransactionServiceListTransactionsProcedure = "/budget.v1.TransactionService/ListTransactions"
	...
	TransactionServiceGetTransactionTotalsProcedure = "/budget.v1.TransactionService/GetTransactionTotals"
	...
	TransactionServiceCreateTransactionProcedure = "/budget.v1.TransactionService/CreateTransaction"
)

// TransactionServiceClient is a client for the budget.v1.TransactionService service.
type TransactionServiceClient interface {
	...
	GetTransactionTotals(context.Context, *connect.Request[v1.GetTransactionTotalsRequest]) (*connect.Response[v1.GetTransactionTotalsResponse], error)
...
// NewTransactionServiceClient constructs a client for the budget.v1.TransactionService service. By
...
func NewTransactionServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TransactionServiceClient {
	...
	transactionServiceMethods := v1.File_budget_v1_transaction_proto.Services().ByName("TransactionService").Methods()
	return &transactionServiceClient{
		...
		getTransactionTotals: connect.NewClient[v1.GetTransactionTotalsRequest, v1.GetTransactionTotalsResponse](
			httpClient,
...
type transactionServiceClient struct {
	...
	getTransactionTotals *connect.Client[v1.GetTransactionTotalsRequest, v1.GetTransactionTotalsResponse]
	createTransaction    *connect.Client[v1.CreateTransactionRequest, v1.CreateTransactionResponse]
}

// ListTransactions calls budget.v1.TransactionService.ListTransactions.
...
// GetTransactionTotals calls budget.v1.TransactionService.GetTransactionTotals.
func (c *transactionServiceClient) GetTransactionTotals(ctx context.Context, req *connect.Request[v1.GetTransactionTotalsRequest]) (*connect.Response[v1.GetTransactionTotalsResponse], error) {
	return c.getTransactionTotals.CallUnary(ctx, req)
}

// CreateTransaction calls budget.v1.TransactionService.CreateTransaction.
...
// TransactionServiceHandler is an implementation of the budget.v1.TransactionService service.
...
func NewTransactionServiceHandler(svc TransactionServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/budget.v1.TransactionService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTransactionServiceHandler) ListTransactions(context.Context, *connect.Request[v1.ListTransactionsRequest]) (*connect.Response[v1.ListTransactionsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("budget.v1.TransactionService.ListTransactions is not implemented"))
}

func (UnimplementedTransactionServiceHandler) GetTransactionTotals(context.Context, *connect.Request[v1.GetTransactionTotalsRequest]) (*connect.Response[v1.GetTransactionTotalsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("budget.v1.TransactionService.GetTransactionTotals is not implemented"))
}
...
func (UnimplementedTransactionServiceHandler) CreateTransaction(context.Context, *connect.Request[v1.CreateTransactionRequest]) (*connect.Response[v1.CreateTransactionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("budget.v1.TransactionService.CreateTransaction is not implemented"))
}
